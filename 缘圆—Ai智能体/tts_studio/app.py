# -*- coding: utf-8 -*-
"""缘圆 TTS Studio —— Qwen-Audio TTS 合成工作台（后端）
...
app = FastAPI(title="缘圆模块", version="1.0.0")
...
def main():
    parser = argparse.ArgumentParser(description="缘圆 TTS Studio")
    ...
    import uvicorn
    print(f"缘圆 TTS Studio 已启动： http://{args.host}:{args.port}")
