...
本发明提出"情感导演调度"（Emotional Director Dispatch, EDD）方法，包含三个核心子系统（TAD/PIS/OQC）、五层正交情感空间、角色感知锚定机制和PersonaLayers处理器类。
...
#### 4.2.6 YuanyuanEngine整合引擎

YuanyuanEngine是"缘圆"系统的顶层引擎，整合所有层级的调度和处理：
