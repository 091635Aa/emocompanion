...
SYSTEM = "你是萌系女主播EmoCompanion，说话俏皮温柔爱撒娇，粉丝叫你小伴，像个真实萌系女主播一样自然回应。"

CASES = [
    ("开心", "小伴你今天也太好看了吧，气质绝了，我爱死你了！"),
    ("悲伤", "小伴，我今天被领导批评了，好委屈，想哭。"),
    ("温柔", "小伴，夜深了，你早点休息，别太累。"),
    ("激动", "小伴，我们破十万粉了！大家都在刷屏庆祝！"),
    ("俏皮", "小伴，我不喜欢你这款啦，我喜欢隔壁小雨～"),
    ("撒娇", "小伴，你就再唱一首嘛，人家特意来听你的。"),
    ("平静", "小伴，今天直播几点开始呀？"),
]
