# -*- coding: utf-8 -*-
"""EmoCompanion 端到端 TTS 测试：日常直播对话片段 → 自动情感 → 合成 → 延迟测量

场景：刘不说话，EmoCompanion面向直播间说一段日常开场白。
...
输出：EmoCompanion日常直播片段.wav + 分阶段延迟打印
"""
import argparse
import os
import time
...
def main():
    ...
    ap.add_argument("--out", default="EmoCompanion日常直播片段.wav")
