# -*- coding: utf-8 -*-
"""EmoCompanion · 桌面对话台（LLM + 外挂情感 TTS）
...
# ---------------------------------------------------------------- 路径
APP_DIR = Path(__file__).resolve().parent            # EmoCompanion_角色挂载与情感注入工程
...
class emocompanionApp:
    def __init__(self, root: tk.Tk):
        self.root = root
        root.title("EmoCompanion · 桌面对话台（LLM + 外挂情感 TTS）")
    ...
    def work(self, user_text):
        ...
        self.append_chat("EmoCompanion", display or reply, "#27ae60")
...
def main():
    ...
    ap = argparse.ArgumentParser(description="EmoCompanion桌面对话台")
