...
def 主函数():
    ...
    try:
        ...
        print('    pip install -r "EmoCompanion智能体\\依赖清单.txt" -i https://pypi.tuna.tsinghua.edu.cn/simple', flush=True)
        input("按回车键退出...")
        return 1
