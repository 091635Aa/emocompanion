...
def 主函数():
    解析器 = argparse.ArgumentParser(description="EmoCompanion智能体 V2")
    ...
    print(f"EmoCompanion智能体 V2 已启动： {地址}", flush=True)
