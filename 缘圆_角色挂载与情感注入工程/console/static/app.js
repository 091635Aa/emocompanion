...
async function openRoleDrawer() {
  ...
  ROLES = j.roles || {};
  const r = ROLES[j.active] || ROLES["缘圆"] || {};
  $("roleName").value = r.name || "缘圆";
